# -*- coding: utf-8 -*-
#
# situation documentation build configuration file, created by
...
file_text = read(fpath('../situation/__meta__.py'))
...
htmlhelp_basename = 'situationdoc'
...
latex_documents = [
    ('index', 'situation.tex', u'situation Documentation',
...
man_pages = [
    ('index', 'situation', u'situation Documentation',
...
texinfo_documents = [
    ('index', 'situation', u'situation Documentation',
        u'Ian Dennis Miller', 'situation', 'One line description of project.',
        'Miscellaneous'),
]
